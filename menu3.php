...
<?php
		...
		$query= "SELECT * FROM nonvegkababs";
		$result= $conn->query($query);

	while($nonvegkababs= $result->fetch_array())
	{
		echo "<h3>" . $nonvegkababs['name'] . "</h3>";
		echo "<h4>" . $nonvegkababs['price'] . "</h4>";
		echo "<p>" . $nonvegkababs['description'] . "<p>";
